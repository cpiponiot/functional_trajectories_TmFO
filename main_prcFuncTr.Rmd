...
## model inference with stan
if (inference_stan) {
  init_f <- function() {list(mu_tmax = c(10,30), mu_theta=1, mu_Delta = c(0.2, 0.2)); }
  
  stan_recruits_2c <- stan(file = "codes/recruits_model_2cohorts.stan", init = init_f)
  traceplot(stan_recruits_2c, pars = c("mu_Delta","mu_tmax","theta"))
