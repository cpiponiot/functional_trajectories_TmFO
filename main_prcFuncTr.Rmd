...
## observations 
df_obs = dynData_recr[,c("trait","WMT","year","np","treatment","idplot")]
...
ggplot(subset(df_CI_pred, treatment=="T1"), aes(x=t, y = med, colour=idplot)) + 
  facet_grid(trait~idplot, scale = "free") + 
...
```{r, fig.height=8, fig.width=10}
ggplot(subset(df_CI_pred, treatment=="T2"), aes(x=t, y = med, colour=idplot)) + 
  facet_grid(trait~idplot, scale = "free") + 
  geom_ribbon(aes(ymin=inf, ymax = sup, fill=idplot), colour=NA, alpha=0.2) + 
  geom_line() + geom_point(aes(y=WMT))  + 
  geom_hline(aes(yintercept=T0), lty=2)
...
```{r, fig.height=8, fig.width=10}
ggplot(subset(df_CI_pred, treatment=="T3"), aes(x=t, y = med, colour=idplot)) + 
  facet_grid(trait~idplot, scale = "free") + 
  geom_ribbon(aes(ymin=inf, ymax = sup, fill=idplot), colour=NA, alpha=0.2) + 
  geom_line() + geom_point(aes(y=WMT))  + 
  geom_hline(aes(yintercept=T0), lty=2)
