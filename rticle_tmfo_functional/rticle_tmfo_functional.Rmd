...
df_pred[, Delta := loss_pred*(lambda0 + lambda_cwd*cwd + lambda_smort*smort)]
...
Acknowledgements
============
The study has been supported by the TRY initiative on plant traits (http://www.try-db.org).
